...
def searchcategory(data):
    ...
    qry = "SELECT " + tbl_customer_data_dtls.get('name') + "." + tbl_customer_data_dtls.get('columns')[0] + " as id, " + tbl_category_dtls.get('name') + "." + tbl_category_dtls.get('columns')[1] + " as category, " + tbl_sub_category_dtls.get('name') + "." + tbl_sub_category_dtls.get('columns')[2] + " as sub_category, " + tbl_city_dtls.get('name') + "." + tbl_city_dtls.get('columns')[1] + " as city, " + tbl_customer_data_dtls.get('name') + "." + tbl_customer_data_dtls.get('columns')[4] + " as content, " + tbl_customer_data_dtls.get('name') + "." + tbl_customer_data_dtls.get('columns')[5] + " as image_url, " + tbl_customer_data_dtls.get('name') + "." + tbl_customer_data_dtls.get('columns')[6] + " as address, " + tbl_customer_data_dtls.get('name') + "." + tbl_customer_data_dtls.get('columns')[7] + " as phone," + tbl_customer_data_dtls.get('name') + "." + tbl_customer_data_dtls.get('columns')[8] + " as latitude," + tbl_customer_data_dtls.get('name') + "." + tbl_customer_data_dtls.get('columns')[9] + " as longitude FROM " + tbl_category_dtls.get('name') + ", " + tbl_sub_category_dtls.get('name') + ", " + tbl_city_dtls.get('name') + ", " + tbl_customer_data_dtls.get('name') + " WHERE " + tbl_category_dtls.get('name') + "." + tbl_category_dtls.get('columns')[0] + "=" + tbl_customer_data_dtls.get('name') + "." + tbl_customer_data_dtls.get('columns')[2] + " AND " + tbl_sub_category_dtls.get('name') + "." + tbl_sub_category_dtls.get('columns')[0] + "=" + tbl_customer_data_dtls.get('name') + "." + tbl_customer_data_dtls.get('columns')[3] + " AND " + tbl_city_dtls.get('name') + "." + tbl_city_dtls.get('columns')[0] + "=" + tbl_customer_data_dtls.get('name') + "." + tbl_customer_data_dtls.get('columns')[1] + " AND " + tbl_sub_category_dtls.get('name') + "." + tbl_sub_category_dtls.get('columns')[1] + "=" + tbl_category_dtls.get('name') + "." + tbl_category_dtls.get('columns')[0] + " AND " + tbl_category_dtls.get('name') + "." + tbl_category_dtls.get('columns')[2] + "=1 AND " + tbl_sub_category_dtls.get('name') + "." + tbl_sub_category_dtls.get('columns')[3] + "=1 AND LOWER(" + tbl_customer_data_dtls.get('name') + "." + tbl_customer_data_dtls.get('columns')[4] + ") LIKE '%" + searchdata + "%'"
...
def filtercategory(data):
    ...
    if(tbl_customer_data_dtls.get('columns')[2] in data and tbl_customer_data_dtls.get('columns')[3] in data):
        ...
        qry = "SELECT " + tbl_customer_data_dtls.get('name') + "." + tbl_customer_data_dtls.get('columns')[0] + " as id, " + tbl_category_dtls.get('name') + "." + tbl_category_dtls.get('columns')[1] + " as category, " + tbl_sub_category_dtls.get('name') + "." + tbl_sub_category_dtls.get('columns')[2] + " as sub_category, " + tbl_city_dtls.get('name') + "." + tbl_city_dtls.get('columns')[1] + " as city, " + tbl_customer_data_dtls.get('name') + "." + tbl_customer_data_dtls.get('columns')[4] + " as content, " + tbl_customer_data_dtls.get('name') + "." + tbl_customer_data_dtls.get('columns')[5] + " as image_url, " + tbl_customer_data_dtls.get('name') + "." + tbl_customer_data_dtls.get('columns')[6] + " as address, " + tbl_customer_data_dtls.get('name') + "." + tbl_customer_data_dtls.get('columns')[7] + " as phone," + tbl_customer_data_dtls.get('name') + "." + tbl_customer_data_dtls.get('columns')[8] + " as latitude," + tbl_customer_data_dtls.get('name') + "." + tbl_customer_data_dtls.get('columns')[9] + " as longitude FROM " + tbl_category_dtls.get('name') + ", " + tbl_sub_category_dtls.get('name') + ", " + tbl_city_dtls.get('name') + ", " + tbl_customer_data_dtls.get('name') + " WHERE " + tbl_category_dtls.get('name') + "." + tbl_category_dtls.get('columns')[0] + "=" + tbl_customer_data_dtls.get('name') + "." + tbl_customer_data_dtls.get('columns')[2] + " AND " + tbl_sub_category_dtls.get('name') + "." + tbl_sub_category_dtls.get('columns')[0] + "=" + tbl_customer_data_dtls.get('name') + "." + tbl_customer_data_dtls.get('columns')[3] + " AND " + tbl_city_dtls.get('name') + "." + tbl_city_dtls.get('columns')[0] + "=" + tbl_customer_data_dtls.get('name') + "." + tbl_customer_data_dtls.get('columns')[1] + " AND " + tbl_sub_category_dtls.get('name') + "." + tbl_sub_category_dtls.get('columns')[1] + "=" + tbl_category_dtls.get('name') + "." + tbl_category_dtls.get('columns')[0] + " AND " + tbl_category_dtls.get('name') + "." + tbl_category_dtls.get('columns')[2] + "=1 AND " + tbl_sub_category_dtls.get('name') + "." + tbl_sub_category_dtls.get('columns')[3] + "=1 AND (" + mixed_statement + ")"
